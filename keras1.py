...
def main():
    ...
    model.fit(X_data, Y_data, batch_size=64, epochs=2, verbose=False)

    score = model.evaluate(X_test, Y_test, batch_size=64, verbose=False)

    Y_predictions = model.predict(X_test, batch_size=64)
